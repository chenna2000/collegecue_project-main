...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='status',
            field=models.CharField(choices=[('selected', 'Selected'), ('not_selected', 'Not Selected'), ('not_eligible', 'Not Eligible'), ('under_review', 'under_review')], default='pending', max_length=20),
        ),
    ]
